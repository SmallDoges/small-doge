...
def format_deepseek_reward(completions, **kwargs):
    r"""
    DeepSeek-style format reward function.
    """
    # This is a placeholder - implement according to DeepSeek's format requirements
...
REWARD_FUNCS_REGISTRY = {
    ...
    "format_deepseek": format_deepseek_reward,
